...
?>
    ...
    <li class="dropdown">
        <i class="ti-bell dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="notify-title">Vous avez <?php echo htmlentities($unreadcount);?> <b>non lu</b> notifications!</span>
            ...
            <?php 
                ...
                {               ?>  
                     ...
                     <a href="employeeCongé-details.php?leaveid=<?php echo htmlentities($result->lid);?>" class="notify-item">
                       <div class="notify-thumb"><i class="ti-comments-smiley btn-info"></i></div>
                       <div class="notify-text">
                       <p><b><?php echo htmlentities($result->FirstName." ".$result->LastName);?>
                                            <br />(<?php echo htmlentities($result->EmpId);?>)
                                            </b> a récemment demandé un demande d'achat.</p>
                            <span>à <?php echo htmlentities($result->PostingDate);?></b</span>
                        </div>
                      </a>

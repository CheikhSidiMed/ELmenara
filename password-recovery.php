<?php
    ...
    $chngpwd1->execute();
    $msg="Votre mot de passe a été récupéré. Entrez de nouvelles informations d’identification pour continuer";
    }
...
<head>
    ...
    <title>Système de gestion des homes des employés</title>
            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        ...
                        <p>Veuillez fournir les coordonnées de votre employé pour la récupération.</p>
                    </div>
                ...
                foreach ($results as $result) {
					...
					<div class="login-form-body">
                        ...
                        <div class="form-gp">
                            <label for="exampleInputEmail1">Entrez un nouveau mot de passe</label>
                            <input type="password" id="exampleInputEmail1" name="newpassword" required autocomplete="off">
                            <i class="ti-key"></i>
                            <div class="text-danger"></div>
                        </div>
                        <div class="form-gp">
                            <label for="exampleInputPassword1">Confirm Mote de passe</label>
                        ...
                        <div class="submit-btn-area">
                            <button id="form_submit" name="change" type="submit">OK <i class="ti-arrow-right"></i></button>
                        </div>
						</form>
                        <?php } else{ ?>

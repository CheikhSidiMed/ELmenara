...
$sql = "SELECT DISTINCT a.activity_name, 
            ...
            LEFT JOIN students_etrang s_e ON sa.student_id_etrang = s_e.id
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($activity_details as $detail): ?>
                                <tr>
                                    <td><?php echo $detail['student_name'] ?? $detail['name'] ; ?></td>
                                    <td><?php echo $detail['class_name'] ?? 'طالب(ة) أجنبي(ة)'; ?></td>
                                    ...
                                    <?php 
                                        ...
                                        if ($remaining_amount === 0.00) {
                                            echo '<strong style="color: green; font-weight: bold;">دفع(ت)</strong>';
                                        } else {

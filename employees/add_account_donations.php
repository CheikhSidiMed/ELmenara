...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($account_number) || empty($account_name) || empty($category) || !is_numeric($account_balance)) {
        ...
        $sql_check = "SELECT 1 FROM donate_accounts WHERE account_number = ?";
        ...
        if ($stmt_check) {
            ...
            if ($stmt_check->num_rows > 0) {
                ...
                $sql = "INSERT INTO donate_accounts (account_number, account_name, category, account_balance) VALUES (?, ?, ?, ?)";

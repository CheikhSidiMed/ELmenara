...
if ($accountNumber) {
    $stmt = $conn->prepare("SELECT account_name FROM expense_accounts WHERE account_number = ?");
    if (!$stmt) {
    ...
    $query = "SELECT transaction_date, transaction_description, amount, payment_method 
          ...
          WHERE expense_account_id = (SELECT id FROM expense_accounts WHERE account_number = ?) 
...
<div class="connt">
    ...
    <div class="sheet-header receipt-header">
        ...
        <div class="col text-end">
            ...
            <div class="summary-value"><span><?= number_format($runningBalanceTot, 2) ?></span></div>

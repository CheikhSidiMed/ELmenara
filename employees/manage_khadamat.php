...
$sql = "SELECT account_number FROM offer_accounts ORDER BY account_number DESC LIMIT 1";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_account_id'])) {
    ...
    // Delete query
    $sql = "DELETE FROM offer_accounts WHERE id = ?";
...
<head>
    ...
    <title> إدارة حسابات مقدمي الخدمات </title>
...
<body>
    <div class="container mt-5">
        ...
        <div class="table-container">
            <h1 class="table-title"> إدارة حسابات مقدمي الخدمات</h1>
            ...
            <table class="table table-striped table-bordered text-center">
                ...
                <tbody>
                    ...
                    // Fetch all accounts
                    $query = "SELECT * FROM offer_accounts";
    ...
    <div class="modal fade" id="editAccountModal" tabindex="-1" aria-labelledby="editAccountLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="edit_account_offers.php" method="POST">
    ...
    <div class="modal fade" id="addAccountModal" tabindex="-1" aria-labelledby="addAccountLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="add_account_offers.php" method="POST">
                    <div class="modal-body">
                        <div class="mb-3">

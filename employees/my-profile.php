                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Département sélectionné</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">APPORTER DES MODIFICATIONS</button>

...
if (!isset($_SESSION['userid'])) {
    ...
    $msg="Votre mot de passe a été mis à jour.";
        ...
        $error="Désolé, votre mot de passe actuel est erroné !";    
    }
}
?>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="#">
                                <a href="home.php" aria-expanded="true"><i class="ti-user"></i><span>Demander un home
                                    </span></a>
                            </li>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Changer le mot de passe actuel</h4>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="chngpwd" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">Changer le mot de passe</h4>
                                        <p class="text-muted font-14 mb-4">Veuillez remplir le formulaire pour modifier votre mot de passe actuel.</p>
                                        ...
                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Nouveau mot de passe</label>
                                            <input class="form-control" type="password" name="newpassword" id="password" autocomplete="off" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">Confirmer le mot de passe</label>
